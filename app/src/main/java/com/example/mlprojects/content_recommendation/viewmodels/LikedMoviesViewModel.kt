package com.example.mlprojects.content_recommendation.viewmodels
...
import com.example.mlprojects.content_recommendation.data.MovieRepository
 ...
 */
class LikedMoviesViewModel internal constructor(application: Application) :
    ...
    init {
        viewModelScope.launch {
            movies.value = MovieRepository.getInstance(application.applicationContext).getContent()
                .toMutableSet()
        }
    }
